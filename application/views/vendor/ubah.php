              ...
              <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group nama col-md-12">
                      <label>Nama</label>
                      <input id="nama" name="nama" type="text" class="form-control" placeholder="..." value="<?php echo $vendor_item['nama']; ?>">
                    ...
                    <div class="form-group hp col-md-12">
                      <label>No. HP</label>
                      <input id="hp" name="hp" type="text" class="form-control" placeholder="..." value="<?php echo $vendor_item['no_hp']; ?>">
                    ...
                    <div class="form-group alamat col-md-12">
                      <label>Alamat</label>
                      <textarea id="alamat" name="alamat" class="form-control" rows="3" placeholder="..."><?php echo $vendor_item['alamat']; ?></textarea>
                      <label class="error" for="alamat" id="alamat_error" hidden><i class="fa fa-times-circle-o"></i> Kolom ini tidak boleh kosong.</label>
                      <label class="vali"  for="alamat" id="alamat_vali" hidden><i class="fa fa-times-circle-o"></i> Hanya boleh memasukkan huruf dan angka.</label>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <!-- text input -->
                    <div class="form-group email col-md-12">
                      ...
                      <input id="email" name="email" type="email" class="form-control" placeholder="..." value="<?php
                                                                                                                if ($vendor_item['email'] == "-") {
                                                                                                                  echo "";
                                                                                                                }
                                                                                                                else {
                                                                                                                  echo $vendor_item['email'];
                                                                                                                }
                                                                                                                 ?>">
