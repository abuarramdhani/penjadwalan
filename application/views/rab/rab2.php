...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Laporan Penjualan
        <small><?php echo $pemesanan_view['klien']; ?></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-md-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> RK Studio <a style="margin-bottom: 10px;" href="<?php echo site_url('pemesanan2/ubah/'.$_SESSION['kd_pemesanan'].'?back=rab2');?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> Ubah</a>
      ...
      <div class="row invoice-info">
        <div class="col-xs-12 col-md-8 invoice-col" style="margin-bottom: 30px;">
          <detail>
      ...
      <div class="row">
        <div class="col-md-12 table-responsive">
          <h3 style="display: inline;"> Alat Yang Disewa</h3> <a style="margin-bottom: 10px;" href="<?php echo site_url('pemesanan2/ubah_detail/'.$_SESSION['kd_pemesanan'].'?back=rab2'); ?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> Ubah</a>
          <table class="table table-hover">
            <thead>
            <tr>
              <th>No</th>
      ...
      <div class="row">
        <div class="col-md-12 table-responsive">
          <h3 style="display: inline; ">Sewa Alat Di Vendor Lain</h3> <a style="margin-bottom: 10px;" href="<?php echo site_url('proses_pemesanan/pilih_peralatan/'.$_SESSION['kd_pemesanan'].'?back=rab2&pemesanan=Alat');?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> Ubah</a>
          <table class="table table-hover">
            <thead>
            <tr>
              <th>No</th>
      ...
      <div class="row no-print">
        <div class="col-md-12  text-center">
          <a href="<?php echo site_url('rab2/print/'.$_SESSION['kd_pemesanan']); ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
        </div>
      </div>
    </section>
    <!-- /.content -->
