                ...
                <div class="box-body">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <select id="tipe" name="tipe" class="form-control select2" style="width: 100%;">
                        ...
                        <option value="<?php echo $tipe_item['kd_tipe']; ?>" <?php if ($peralatan_item['kd_tipe'] == $tipe_item['kd_tipe']) { echo "selected"; } ?>><?php echo $tipe_item['merk']." || ".$tipe_item['nama']." || ".$tipe_item['kategori']; ?>
                        </option>
                       <?php } ?>
                      </select>
                    </div>
                    ...
                    <?php
                      $kode = explode("-", $peralatan_item['kd_peralatan']);
                      $kode = $kode[0];
                      ?>
                    <!-- text input -->
                    <div class="form-group kode col-md-12">
                        <label style="width: 100%;">Kode</label>
                        <input style="text-transform:uppercase; float: left; width: 50%; margin: 0px;" id="kode" name="kode" type="text" class="form-control" value="<?php echo $kode; ?>" placeholder="..." >
