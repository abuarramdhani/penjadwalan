              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <!-- Left Form -->
                    ...
                    <!-- text input -->
                    <div class="form-group password col-md-12">
                      ...
                      <i class="show fa fa-unlock-alt"></i>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group npwp col-md-12">
                        <label>NPWP</label>
                        <input id="npwp" name="npwp" type="text" class="form-control" placeholder="...">
                      ...
                      <div class="form-group jabatan col-md-12">
                        ...
                        <select id="jabatan" name="jabatan" class="form-control">
                          ...
                          <option value="<?php echo $jabatan_item['kd_jabatan']; ?>" ><?php echo $jabatan_item['nama']; ?></option>
                         <?php } ?>
                        </select>
                      </div>
                      <!-- Date -->
                      <div class="form-group mulai_kerja col-md-12">
                        ...
                        <div class="input-group date">
                          ...
                          <input style="background: white;" type="text" name="mulai_kerja" class="form-control pull-right" id="datepicker2" placeholder="dd/mm/yyyy" readonly="readonly">
                        </div>
                      ...
                      <div class="form-group col-md-5 col-xs-6">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" name="status_pegawai" id="status1" value="tetap" checked> Pegawai Tetap
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" name="status_pegawai" id="status2" value="magang"> Pegawai Magang
                            </label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group col-md-4 col-xs-6">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" name="status_user" id="status1" value="superadmin" checked> Superadmin
                            </label>
                          </div>
                          <div class="radio">
                            <label>
                              <input type="radio" name="status_user" id="status2" value="user"> User
                            </label>
                          </div>
                        </div>
                      </div>
