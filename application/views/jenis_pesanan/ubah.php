              ...
              <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group nama col-md-12">
                      <label>Nama</label>
                      <input id="nama" name="nama" type="text" class="form-control" placeholder="..." value="<?php echo $jenis_pesanan_item['nama']; ?>">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <div class="col-md-12">
                        <?php
                        if ($jenis_pesanan_item['status'] == 'on') {
                          $on  = 'checked';
                          $off = '';
                        }else {
                          $on  = '';
                    ...
                    <div class="col-md-12">
                          <div class="col-md-12">
                            <div class="text-center">
                              <a style="margin-right: 10px;" href="<?php echo site_url('jenis_pesanan/jenis_pesanan'); ?>" class="btn btn-danger"><i class="fa fa-remove"></i> Batal</a>
