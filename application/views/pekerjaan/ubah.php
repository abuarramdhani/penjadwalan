              ...
              <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group nama col-md-12">
                      <label>Nama</label>
                      <input id="nama" name="nama" type="text" class="form-control" placeholder="..." value="<?php echo $pekerjaan_item['nama']; ?>">
                ...
                <div class="col-md-12">
                      <div class="col-md-12">
                        <div class="text-center">
                          <a href="<?php echo site_url('pekerjaan/pekerjaan'); ?>" class="btn btn-danger"><i class="fa fa-remove"></i> Batal</a>
